...
const LastWord = (str) => {
  ...
  return splitted.slice(splitted.length - 1)[0];
};
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
  // write your code here
  let splitted = str.split(" ");
  let iIndex = splitted.indexOf("I");
  let amIndex = splitted.indexOf("am");
  let areIndex = splitted.indexOf("was");

  if (iIndex != -1) {
    splitted.splice(iIndex, 1, "We");
  }
  if (amIndex != -1) {
    splitted.splice(amIndex, 1, "are");
  }
  if (areIndex != -1) {
    splitted.splice(areIndex, 1, "were");
  }
